...
| Asset | Purpose |
|-------|---------|
| `docker/docker-compose.yml` | Complete Docker stack definition |
| `docker/Dockerfile.airflow` | Custom Airflow image with JDK + Spark |
| `producers/user_events_producer.py` | Mock data generator (upstream system) |
| `producers/transaction_events_producer.py` | Mock data generator (upstream system) |
